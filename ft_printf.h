...
/*   Updated: 2017/05/12 17:02:14 by rbozhko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define INT_CHARS(type) (type == 'd' || type == 'i')
# define NOT_HEX_CHARS(type) (type != 'X' && type != 'x')
...
# define CONVERSION_FLAGS(type) ((type == '%' || type == 's' || type == 'S' \
|| type == 'p' || TPCST_INT(type) || type == 'c' || type == 'C') ? 1 : 0)
# define TPCST_INT(type) ((INT_CHARS(type) || (type == 'D') || (type == 'u') \
|| (type == 'o') || (type == 'O') || (type == 'x') || (type == 'X') || (type == 'U')) ? 1 : 0)
