...
typedef void *(*ft_typecast_arg)(void*, t_instruction *instruction);
typedef void (*ft_chng_instrc)(t_instruction *instruction);
typedef void (*ft_get_arg_due_to_type)(t_instruction *instruction, va_list ap);
